...
def perform_gesture_action(gesture, current_time):
    ...
    if current_time - prev_gesture_time > gesture_cooldown:
        ...
        elif gesture == "Toggle Pointer":
            keyboard.press_and_release('b')
        elif gesture == "Exit Presentation":
...
def detect_gesture(lm, img_w, img_h):
    ...
    if index_middle_dist > 60 and thumb_index_dist > 60:
        ...
        return "Toggle Pointer"
    elif index_to_wrist < 40:
...
while True:
    ...
    if gesture_name:
        cv2.putText(img, gesture_name, (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 3)

    cv2.imshow("Presentation Gesture Control", img)
